...
<div class="em-booking-login">
	...
	<p><?php esc_html_e('Log in with your solis-id.','events-manager'); ?></p>
    <p>
	...
	<input type="submit" name="wp-submit" id="em_wp-submit" value="<?php esc_html_e('Log In', 'events-manager'); ?>" tabindex="100" /><br />
	<input name="rememberme" type="checkbox" id="em_rememberme" value="forever" /> <?php esc_html_e( 'Remember Me','events-manager') ?>
